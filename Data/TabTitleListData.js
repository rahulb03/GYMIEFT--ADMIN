...
export const SettingPaymentMethodTab = [
  ...
  { title: "Razorpay", icon: "₹ ", inputs: ["mail_mailer", "mail_host", "mail_port", "mail_username", "mail_password", "mail_encryption", "mail_from_address", "mail_from_name", "mailgun_domain", "mailgun_secret"] },
...
export const HeaderOption = [
  { id: 1, title: "Header 1", value: 'basic_header', dummyImg: "/assets/images/theme-option/header/01.jpg", realImg: "/assets/images/theme-option/header/1.jpg" },
  { id: 2, title: "Header 2", value: 'classic_header', dummyImg: "/assets/images/theme-option/header/02.jpg", realImg: "/assets/images/theme-option/header/2.jpg" },
  { id: 3, title: "Header 3", value: 'standard_header', dummyImg: "/assets/images/theme-option/header/03.jpg", realImg: "/assets/images/theme-option/header/3.jpg" },
  { id: 4, title: "Header 4", value: 'minimal_header', dummyImg: "/assets/images/theme-option/header/5.jpg", realImg: "/assets/images/theme-option/header/05.jpg" },
]
...
export const CollectionLayoutOption = [
  { id: 1, value: "collection_category_slider", title: "Collectioncategoryslider", img: "/assets/images/theme-option/shop/10.jpg" },
  { id: 2, value: "collection_category_sidebar", title: "CollectionCategorySidebar", img: "/assets/images/theme-option/shop/11.jpg" },
  { id: 3, value: "collection_banner", title: "CollectionBanner", img: "/assets/images/theme-option/shop/03.jpg" },
  { id: 4, value: "collection_left_sidebar", title: "CollectionLeftSidebar", img: "/assets/images/theme-option/shop/04.jpg" },
  { id: 5, value: "collection_list", title: "CollectionList", img: "/assets/images/theme-option/shop/05.jpg" },
  { id: 6, value: "collection_right_sidebar", title: "CollectionRightSidebar", img: "/assets/images/theme-option/shop/06.jpg" },
  { id: 7, value: "collection_offcanvas_filter", title: "CollectionTopFilter", img: "/assets/images/theme-option/shop/07.jpg" }
]
export const ProductLayoutOption = [
  { id: 1, value: "product_images", title: "ProductImage", img: "/assets/images/theme-option/product/01.jpg" },
  { id: 2, value: "product_thumbnail", title: "ProductThumbnail", img: "/assets/images/theme-option/product/02.jpg" },
  { id: 3, value: "product_slider", title: "ProductSlider", img: "/assets/images/theme-option/product/04.jpg" },
  { id: 4, value: "product_sticky", title: "ProductSticky", img: "/assets/images/theme-option/product/07.jpg" }
]
export const BlogStyleOption = [
  { value: "grid_view", title: "GridView", img: "/assets/images/theme-option/shop/01.jpg" },
  { value: "list_view", title: "ListView", img: "/assets/images/theme-option/shop/02.jpg" },
]
export const BlogTypeOption = [
  { value: 'left_sidebar', title: 'LeftSidebar', img: "/assets/images/theme-option/shop/01.jpg" },
  { value: 'right_sidebar', title: 'RightSidebar', img: "/assets/images/theme-option/shop/08.jpg" },
  { value: 'no_sidebar', title: 'NoSidebar', img: "/assets/images/theme-option/shop/09.jpg" }
]
...
export const SellerAboutStore = [
  { value: 'basic_store', title: 'BasicStore', img: "/assets/images/theme-option/seller/basic.png" },
  { value: 'classic_store', title: 'ClassicStore', img: "/assets/images/theme-option/seller/classic.png" },
]
export const SellerSetailsStore = [
  { value: 'basic_store_details', title: 'BasicStoreDetails', img: "/assets/images/theme-option/seller/basic-details.png" },
  { value: 'classic_store_details', title: 'ClassicStoreDetails', img: "/assets/images/theme-option/seller/classic-details.png" },
]

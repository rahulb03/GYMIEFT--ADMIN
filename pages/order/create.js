...
const POS = () => {
  ...
  const { data: addToCartData, isLoading: addToCartLoader, refetch } = useQuery([AddtoCartAPI], () => request({ url: AddtoCartAPI }), { enabled: true, refetchOnWindowFocus: false, select: (res) => res?.data });
